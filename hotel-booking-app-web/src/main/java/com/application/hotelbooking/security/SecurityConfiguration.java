    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> {
                    auth.requestMatchers("/hotelbooking/home/**", "/hotelbooking/newHome/**", "/hotelbooking/search-rooms/**", "/hotelbooking/search-rooms-new/**", "/hotelbooking/register/**", "/error/**").permitAll();
