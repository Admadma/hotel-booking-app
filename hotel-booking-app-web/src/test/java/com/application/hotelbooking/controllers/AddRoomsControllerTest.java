...
public class AddRoomsControllerTest {
    ...
    private static final RoomCreationDTO ROOM_CREATION_DTO = new RoomCreationDTO(1, 1, 1, RoomType.FAMILY_ROOM, 1L);
    private static final RoomCreationServiceDTO ROOM_CREATION_SERVICE_DTO = new RoomCreationServiceDTO(1L, 1, 1, 1, 1, RoomType.FAMILY_ROOM, 1L);
