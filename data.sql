...
INSERT INTO rooms (room_number, single_beds, double_beds, price_per_night, room_type, version, hotel_id) VALUES
    ...
    (2, 1, 0, 10000, 'SINGLE_ROOM', 1, 1),
    (3, 1, 0, 10000, 'SINGLE_ROOM', 1, 1),
    (4, 1, 0, 10000, 'SINGLE_ROOM', 1, 1),
    (5, 1, 0, 10000, 'SINGLE_ROOM', 1, 1),
    (6, 2, 1, 30000, 'FAMILY_ROOM', 1, 1),
    (7, 2, 1, 30000, 'FAMILY_ROOM', 1, 1),
    (8, 2, 1, 30000, 'FAMILY_ROOM', 1, 1),
    (9, 2, 1, 30000, 'FAMILY_ROOM', 1, 1),
    (10, 2, 1, 30000, 'FAMILY_ROOM', 1, 1),
    (11, 2, 2, 40000, 'TWIN_ROOM', 1, 1),
    (12, 2, 2, 40000, 'TWIN_ROOM', 1, 1),
    (13, 2, 2, 40000, 'TWIN_ROOM', 1, 1),
    (14, 2, 2, 40000, 'TWIN_ROOM', 1, 1),
    (15, 2, 2, 40000, 'TWIN_ROOM', 1, 1),
    (1, 1, 0, 10000, 'SINGLE_ROOM', 1, 2),
    (2, 1, 0, 10000, 'SINGLE_ROOM', 1, 2),
    (3, 1, 0, 10000, 'SINGLE_ROOM', 1, 2),
    (4, 1, 0, 10000, 'SINGLE_ROOM', 1, 2),
    (5, 1, 0, 10000, 'SINGLE_ROOM', 1, 2),
    (6, 2, 1, 30000, 'FAMILY_ROOM', 1, 2),
    (7, 2, 1, 30000, 'FAMILY_ROOM', 1, 2),
    (8, 2, 1, 30000, 'FAMILY_ROOM', 1, 2),
    (9, 2, 1, 30000, 'FAMILY_ROOM', 1, 2),
    (10, 2, 1, 30000, 'FAMILY_ROOM', 1, 2),
    (11, 2, 2, 40000, 'TWIN_ROOM', 1, 2),
    (12, 2, 2, 40000, 'TWIN_ROOM', 1, 2),
    (13, 2, 2, 40000, 'TWIN_ROOM', 1, 2),
    (14, 2, 2, 40000, 'TWIN_ROOM', 1, 2),
    (15, 2, 2, 40000, 'TWIN_ROOM', 1, 2),
    (1, 1, 0, 10000, 'SINGLE_ROOM', 1, 3),
    (2, 1, 0, 10000, 'SINGLE_ROOM', 1, 3),
    (3, 1, 0, 10000, 'SINGLE_ROOM', 1, 3),
    (4, 1, 0, 10000, 'SINGLE_ROOM', 1, 3),
    (5, 1, 0, 10000, 'SINGLE_ROOM', 1, 3),
    (6, 2, 1, 30000, 'FAMILY_ROOM', 1, 3),
    (7, 2, 1, 30000, 'FAMILY_ROOM', 1, 3),
    (8, 2, 1, 30000, 'FAMILY_ROOM', 1, 3),
    (9, 2, 1, 30000, 'FAMILY_ROOM', 1, 3),
    (10, 2, 1, 30000, 'FAMILY_ROOM', 1, 3),
    (11, 2, 2, 40000, 'TWIN_ROOM', 1, 3),
    (12, 2, 2, 40000, 'TWIN_ROOM', 1, 3),
    (13, 2, 2, 40000, 'TWIN_ROOM', 1, 3),
    (14, 2, 2, 40000, 'TWIN_ROOM', 1, 3),
    (15, 2, 2, 40000, 'TWIN_ROOM', 1, 3),
    (1, 1, 0, 10000, 'SINGLE_ROOM', 1, 4),
    (2, 1, 0, 10000, 'SINGLE_ROOM', 1, 4),
    (3, 1, 0, 10000, 'SINGLE_ROOM', 1, 4),
    (4, 1, 0, 10000, 'SINGLE_ROOM', 1, 4),
    (5, 1, 0, 10000, 'SINGLE_ROOM', 1, 4),
    (6, 2, 1, 30000, 'FAMILY_ROOM', 1, 4),
    (7, 2, 1, 30000, 'FAMILY_ROOM', 1, 4),
    (8, 2, 1, 30000, 'FAMILY_ROOM', 1, 4),
    (9, 2, 1, 30000, 'FAMILY_ROOM', 1, 4),
    (10, 2, 1, 30000, 'FAMILY_ROOM', 1, 4),
    (11, 2, 2, 40000, 'TWIN_ROOM', 1, 4),
    (12, 2, 2, 40000, 'TWIN_ROOM', 1, 4),
    (13, 2, 2, 40000, 'TWIN_ROOM', 1, 4),
    (14, 2, 2, 40000, 'TWIN_ROOM', 1, 4),
    (15, 2, 2, 40000, 'TWIN_ROOM', 1, 4),
    (1, 1, 0, 10000, 'SINGLE_ROOM', 1, 5),
    (2, 1, 0, 10000, 'SINGLE_ROOM', 1, 5),
    (3, 1, 0, 10000, 'SINGLE_ROOM', 1, 5),
    (4, 1, 0, 10000, 'SINGLE_ROOM', 1, 5),
    (5, 1, 0, 10000, 'SINGLE_ROOM', 1, 5),
    (6, 2, 1, 30000, 'FAMILY_ROOM', 1, 5),
    (7, 2, 1, 30000, 'FAMILY_ROOM', 1, 5),
    (8, 2, 1, 30000, 'FAMILY_ROOM', 1, 5),
    (9, 2, 1, 30000, 'FAMILY_ROOM', 1, 5),
    (10, 2, 1, 30000, 'FAMILY_ROOM', 1, 5),
    (11, 2, 2, 40000, 'TWIN_ROOM', 1, 5),
    (12, 2, 2, 40000, 'TWIN_ROOM', 1, 5),
    (13, 2, 2, 40000, 'TWIN_ROOM', 1, 5),
    (14, 2, 2, 40000, 'TWIN_ROOM', 1, 5),
    (15, 2, 2, 40000, 'TWIN_ROOM', 1, 5),
    (1, 1, 0, 10000, 'SINGLE_ROOM', 1, 6),
    (2, 1, 0, 10000, 'SINGLE_ROOM', 1, 6),
    (3, 1, 0, 10000, 'SINGLE_ROOM', 1, 6),
    (4, 1, 0, 10000, 'SINGLE_ROOM', 1, 6),
    (5, 1, 0, 10000, 'SINGLE_ROOM', 1, 6),
    (6, 2, 1, 30000, 'FAMILY_ROOM', 1, 6),
    (7, 2, 1, 30000, 'FAMILY_ROOM', 1, 6),
    (8, 2, 1, 30000, 'FAMILY_ROOM', 1, 6),
    (9, 2, 1, 30000, 'FAMILY_ROOM', 1, 6),
    (10, 2, 1, 30000, 'FAMILY_ROOM', 1, 6),
    (11, 2, 2, 40000, 'TWIN_ROOM', 1, 6),
    (12, 2, 2, 40000, 'TWIN_ROOM', 1, 6),
    (13, 2, 2, 40000, 'TWIN_ROOM', 1, 6),
    (14, 2, 2, 40000, 'TWIN_ROOM', 1, 6),
    (15, 2, 2, 40000, 'TWIN_ROOM', 1, 6);
